...
const numbersUnder501 = crazyNumbers.reduce((accumulator, number) =>
  number < 501 ? accumulator + 1 : accumulator, 0)
...
const namesOfTvShows = tvShows.map(({ name }) => name)
